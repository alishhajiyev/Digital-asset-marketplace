...
export default function MainPage() {
  return (
    <div id='MainPage'>
      <div style={{ display: "flex",padding:"120px" }} className="upside"><h1>Buy, trade, and donate cryptocurrencies on CryptoCell</h1><Link to={"buycrypto"}><button className="MainPage-start"> Get Started </button></Link></div>
